...
const ROOT_QUERY_API_CONTRACT = {
  ...
  sampleVisualId: "vis.physics.series-circuit-flow",
  sampleVisualEnglishTitle: "Series Circuit Teaching Flow",
  sampleVisualResolvedSuffix: ["visuals", "physics", "vis.physics.series-circuit-flow.svg"]
};
